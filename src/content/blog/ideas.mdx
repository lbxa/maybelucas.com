...
7. Nano fabrication
    - Nano fabrication is the process of creating structures at the nanoscale e.g., nano-particle drug delivery system
    - Just like anyone can buy a 3D printer today, nano fabricators should become consumer-grade
8. Rapid regenerative cells
    - Needs to be capable of healing any sickness
    - Makes human immune system tolerant to all disease
    - Extends average life expectancy beyond 100 years
    - Most likely it’s designed by the AGI above
9. Modular $Q> 1$ fusion
    - Large-scale fusion might work economically as the price of solar and lithium continue to plummet
    - Modular fusion cells could power robots and deep space vessels for extended periods of time due to a superior energy density
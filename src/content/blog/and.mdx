...
<Image src={venn} class="w-full md:w-3/5 mx-auto" alt="Overlapping sets illustrating inclusion over exclusivity" caption="A Venn diagram of two mutually exclusive events: no overlap means they cannot both occur at the same time." />

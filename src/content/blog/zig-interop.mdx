...
$$
e_{n+1} = \frac{1}{2}\left(g_n + \frac{x}{g_n}\right) - \sqrt{x} = \frac{g_n^2 + x - 2 g_n \sqrt{x}}{2g_n} = \frac{(g_n - \sqrt{x})^2}{2g_n} = \frac{e_n^2}{2g_n}
$$

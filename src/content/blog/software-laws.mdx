...
I disagree with this one mostly over personal preference. I always opt to choose new technologies, e.g., GraphQL over REST, to stay intellectually stimulated when I’m writing out tens of thousands of lines of code. When you know exactly what the shape of the next 10k lines are going to look like… well, that’s just boring. I’ve always compared the craft of software closely to the art of writing or painting. If you’re bored, you won’t paint a masterpiece.

In the era of Claude 4 and Gemini 2.5, boring boilerplaty technologies like SQLite and PHP might be more reliable since they’re more prevalent in the training data hence the models make fewer mistakes. Hopefully this diminishes as the models get progressively more capable.
...
> People in a hierarchy tend to rise to a level of incompetence.
> 

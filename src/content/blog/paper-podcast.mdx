...
I’ve extracted the text from PDF files and piped it to OpenAI’s voice API. It was cheaper to convert Andrej Kaparthy’s PhD thesis to a 3hr mp3 file for \$3.20 than to print it for 0.2c/side totalling $19 for 90 pages.
